...
namespace param {
	...
	const enum class CONTENT_ID {
		KYOTO_TOWER, HIGASHIHONGANJI, SYOSEIEN, NISHIHONGANJI, KIYOMIZUDERA, KYOTO_AQUARIUM, KANNONJI, TOJI, 
		EIJUAN, SODOH, FUNATSURU, HANAROKU, RANTEI, MARUYASU, IMASA, SAWASHO,
		AEON_MALL, ISETAN, AVANTI, TAKASHIMAYA, YAMASHITA, HOBBY_SQUARE_KYOTO, GION_NARUMIYA, UNIQLO,
		ALMONT, SAKURA_HONGANJI, KYOSTAY_IROHA_TOJI, HYATT_REGENCY, FAMILY_VILLA_KEAGE, MUROMACHI_YUTONE, KURAYA, TOKIWAAN
	};
