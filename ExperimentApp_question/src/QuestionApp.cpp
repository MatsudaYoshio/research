...
const array<array<string, QuestionApp::question_number>, MENU_ITEM_NUMBER> QuestionApp::questions = { {
	{ u8"wifiが使えて,世界遺産であるところは?", u8"料金が最も高いのは?", u8"国宝があるのは?", u8"車いすが使えて,午前7時から入れるのは?" },
	{ u8"フレンチが出るのは?", u8"禁煙で料金が5000円以下なのは?", u8"午後8時までに入れて,個室があるのは?", u8"料金が最も高いのは?" },
	{ u8"最も遅くまで営業しているのは?", u8"Wifiが使えて,レストランがあるのは?", u8"午前8時から入れるのは?", u8"試食とラッピングのサービスがあるのは?" },
