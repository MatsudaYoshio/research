...
void MenuBar::setup(HandCursor* const hc) {
	...
	items[static_cast<int>(MENU_ITEM_ID::RESTAURANT)].setup("C:/of_v0.9.8_vs_release/apps/myApps/NewMapApp/fig/restaurant_icon.png", ofRectangle(DISPLAY_W / 3, DISPLAY_H - DISPLAY_W / 9 - 50, DISPLAY_W / 9, DISPLAY_W / 9), "Restaurants", 1367, 2075, MENU_ITEM_ID::RESTAURANT);
	...
	items[static_cast<int>(MENU_ITEM_ID::HOTEL)].setup("C:/of_v0.9.8_vs_release/apps/myApps/NewMapApp/fig/hotel_icon.png", ofRectangle(7 * DISPLAY_W / 9, DISPLAY_H - DISPLAY_W / 9 - 50, DISPLAY_W / 9, DISPLAY_W / 9), "Hotels", 3142, 2075, MENU_ITEM_ID::HOTEL);
