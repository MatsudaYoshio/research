...
void Pin::setup(param::CONTENT_ID content_id) {
	...
	this->number_font.loadFont("./font/meiryob.ttc", this->font_size);
	this->name_font.loadFont("./font/Verdana.ttf", this->font_size);
	...
	this->big_number_font.loadFont("./font/meiryob.ttc", this->big_font_size);
	this->big_name_font.loadFont("./font/Verdana.ttf", this->big_font_size);
