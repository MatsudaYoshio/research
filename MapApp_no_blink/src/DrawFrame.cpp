...
void DrawFrame::make_path() {
	...
	this->path.rectangle(this->frame_rect.getX() + this->size, this->frame_rect.getY() + this->size, this->frame_rect.getWidth() - (this->size << 1), this->frame_rect.getHeight() - (this->size << 1));
}
