...
void HistoryPlotter::draw() {
	...
	ofDrawBitmapString(ofToString(plot_high, this->precision), 1 + this->draw_area.getX(), this->draw_area.getY() + 10);
	ofDrawBitmapString(ofToString(plot_low, this->precision), 1 + this->draw_area.getX(), this->draw_area.getY() + this->draw_area.getHeight() - 1);
