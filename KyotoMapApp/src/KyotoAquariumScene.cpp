...
void KyotoAquariumScene::setup() {
	...
	this->img.load("C:/of_v0.9.8_vs_release/apps/myApps/KyotoMap/fig/kyoto_aquarium.jpg");
...
void KyotoAquariumScene::update() {

}

void KyotoAquariumScene::draw() {
	...
	case static_cast<int>(LANGUAGE_ID::JAPANENE) :
		...
		this->title_font.drawString(L"‹ž“s…‘°ŠÙ", 50, HALF_MAX_SUB_WINDOW_H + 100);
		...
		this->sentence_font.drawString(L"10:00~18:00", 470, HALF_MAX_SUB_WINDOW_H + 200);
		...
		ofSetColor(ofColor::red);
		this->sentence_font.drawString(L"\n\n‹ž“sŽs‰º‹ž‹æŠÏŠìŽ›’¬35-1", 330, HALF_MAX_SUB_WINDOW_H + 200);
		...
		ofSetColor(ofColor::red);
		this->sentence_font.drawString(L"\n\n\n\n075-354-3130", 470, HALF_MAX_SUB_WINDOW_H + 200);

		break;
	case static_cast<int>(LANGUAGE_ID::ENGLISH) :
		ofSetColor(ofColor::black);
		this->title_font.drawString(L"Kyoto", 30, HALF_MAX_SUB_WINDOW_H + 100);
		this->title_font.drawString(L"Aquarium", 360, HALF_MAX_SUB_WINDOW_H + 100);
		...
		ofSetColor(ofColor::red);
		this->sentence_font.drawString(L"10:00AM-18:00PM", 630, HALF_MAX_SUB_WINDOW_H + 200);
		...
		ofSetColor(ofColor::red);
		this->sentence_font.drawString(L"\n\n2,050yen(Adults)", 630, HALF_MAX_SUB_WINDOW_H + 200);
		...
		ofSetColor(ofColor::red);
		this->sentence_font.drawString(L"\n\n\n\n075-354-3130", 290, HALF_MAX_SUB_WINDOW_H + 200);
