...
void HigashihonganjiScene::draw() {
	...
	case static_cast<int>(LANGUAGE_ID::JAPANENE) :
		...
		this->title_font.drawString(L"“Œ–{ŠèŽ›i^@–{•_j", 50, HALF_MAX_SUB_WINDOW_H + 100);

		ofSetColor(ofColor::white);
		this->clock_texture.draw(this->clock_rect);
		ofSetColor(ofColor::black);
		this->sentence_font.drawString(L"ŠJ–åE•Â–åŽžŠÔF", 130, HALF_MAX_SUB_WINDOW_H + 200);
		ofSetColor(ofColor::red);
		this->sentence_font.drawString(L"6:20~16:30(11ŒŽ~2ŒŽ)", 660, HALF_MAX_SUB_WINDOW_H + 200);
		...
		ofSetColor(ofColor::red);
		this->sentence_font.drawString(L"\n\n‹ž“sŽs‰º‹ž‹æ‰GŠÛ’ÊŽµðã‚éí—t’¬754", 330, HALF_MAX_SUB_WINDOW_H + 200);
	...
	case static_cast<int>(LANGUAGE_ID::ENGLISH) :
		ofSetColor(ofColor::black);
		this->title_font.drawString(L"Higashi-Hongan-ji", 30, HALF_MAX_SUB_WINDOW_H + 100);
		this->title_font.drawString(L"Temple", 1000, HALF_MAX_SUB_WINDOW_H + 100);
		...
		ofSetColor(ofColor::red);
		this->sentence_font.drawString(L"6:20AM-16:30PM", 630, HALF_MAX_SUB_WINDOW_H + 200);
		...
		ofSetColor(ofColor::red);
		this->sentence_font.drawString(L"\n\nFree", 630, HALF_MAX_SUB_WINDOW_H + 200);
		...
		ofSetColor(ofColor::red);
		this->sentence_font.drawString(L"\n\n\n\n075-371-9181", 290, HALF_MAX_SUB_WINDOW_H + 200);
