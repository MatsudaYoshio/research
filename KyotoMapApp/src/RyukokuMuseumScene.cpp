...
void RyukokuMuseumScene::draw() {
	...
	this->title_font.drawString(L"—´’Jƒ~ƒ…[ƒWƒAƒ€", 50, H / 4 + 50);

	this->sentence_font.drawString(L"¡ŠJŠÙŽžŠÔF", 40, H / 4 + 100);
	ofSetColor(ofColor::red);
	this->sentence_font.drawString(L"10:00~17:00(–ˆTŒŽ—j“ú‚Í‹xŠÙ)", 200, H / 4 + 100);
	ofSetColor(ofColor::black);
	this->sentence_font.drawString(L"\n\n¡ZŠF", 40, H / 4 + 100);
	ofSetColor(ofColor::red);
	this->sentence_font.drawString(L"\n\n‹ž“sŽs‰º‹ž‹æ–xì’Ê³–Ê‰º‚é", 150, H / 4 + 100);
	ofSetColor(ofColor::black);
	this->sentence_font.drawString(L"\n\n\n\n¡TELF", 40, H / 4 + 100);
	ofSetColor(ofColor::red);
	this->sentence_font.drawString(L"\n\n\n\n075-351-2500", 150, H / 4 + 100);
}